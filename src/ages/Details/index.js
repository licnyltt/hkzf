...
export default class Details extends Component {
  ...
  handleFavorite = async () => {
    ...
    // 没有登录
    if (!isAuth()) {
      return Modal.alert('提示', '登录后才能收藏，是否登录？', [
        { text: '取消' },
        {
          text: '确定',
          onPress: () =>
      ...
      return () => <Modalalert info='登录后才能收藏，是否登录？'></Modalalert>
      // return <Modalalert info='登录后才能收藏，是否登录？'></Modalalert>
    }
    ...
    if (this.state.isFavorite) {
      ...
      if (res.data.status === 200) {
        ...
        // <Modalalert info='登录后才能收藏，是否登录？' ></Modalalert>
        // (() => <Modalalert info='登录后才能收藏，是否登录？'></Modalalert>)()
